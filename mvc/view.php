            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/mvc">
                        ...
                        <tbody>
                            <?php foreach ($users as $user) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $user['age'] ?></td>
                                    <td>
                                        <a class="btn btn-primary" href="show-user.php?id=<?= $user['id'] ?>">
                                            <img src="https://cdn-icons-png.flaticon.com/512/709/709612.png" alt="Show" width="15">
                                        </a>
                                        <a class="btn btn-warning" href="edit-user.php?id=<?= $user['id'] ?>">
                                            <img src="https://cdn-icons-png.flaticon.com/512/1159/1159633.png" alt="Edit" width="15">
                                        </a>
                                        <a class="btn btn-danger" href="delete-user.php?id=<?= $user['id'] ?>">
